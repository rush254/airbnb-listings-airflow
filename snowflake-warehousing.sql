...
ENABLED = TRUE
STORAGE_ALLOWED_LOCATIONS = ('gcs://australia-southeast1-bde-cf574f7c-bucket/data');

DESCRIBE INTEGRATION GCP;

list@stage_gcp;

CREATE STAGE stage_gcp
storage_integration = GCP
url='gcs://australia-southeast1-bde-cf574f7c-bucket/data';
